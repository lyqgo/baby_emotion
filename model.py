# -*- coding: utf-8 -*-
"""
Created on Sun Jul 14 21:12:30 2019
...
class MobileNetV1(object):
    ...
    def _create_placeholders(self):
        self.input = tf.placeholder(dtype=tf.float32, shape=[None, self.input_size, self.input_size, 3])   ########## change
...
if __name__ == '__main__':
    ...
    fake_data = np.ones(shape=(1, 224, 224, 1))
